package app.coffeeTypes.latteMacchiato;
...
public class LatteMacchiatoFactory implements CoffeeFactory {
    ...
    public Coffee createCoffee(String beanType, int totalVolume) {
        ...
        return new LatteMacchiato(color, totalVolume, ingredients);
    }
}
